...
Example: tools/snli_preprocess.py data/snli/snli_1.0_train.jsonl data/snli/snli_1.0_test.jsonl data/snli/snli_1.0_train.pickle data/snli/snli_1.0_test.pickle  data/snli/valset.pickle data/snli/v1-vocab.pickle
"""
...
def load_set(self,fname):
    s0, s1, labels = loader.load_snli(fname, self.vocab)
